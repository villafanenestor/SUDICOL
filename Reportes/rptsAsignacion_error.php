...
function rptDetalleAsignacion(){
	...
	$completa .= $procesos != "" ? " and p.proceso in ($procesos)" : " ";
	 ...
	 $consulta = " 
	  ...
	  t.nombre as nombreTalla,p.proceso,p.cantidad,p.realizado,pr.nombre as nombreProveedor,u.nombre as nombreUsuario, p.cons, p.observacion, p.fechainicial, p.fechafinal
	...
	if($resultado->num_rows > 0){
		...
		while($row = $resultado->fetch_array()){
            ...
            $cantidadRealizados = $row['realizado'];
