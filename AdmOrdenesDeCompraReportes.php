...
<head>
  ...
  <script type="text/javascript">
    ...
    const descargar  = ()=>{
      ...
      const fechaInicio = $("#Desde").val();
      const fechaFinal = $("#Hasta").val();
      const estado = $("#estado").val();

      window.open(`Reportes/rptDetalleOrdenesCompra.php?cliente=${cliente}&fechaInicio=${fechaInicio}&fechaFinal=${fechaFinal}&estado=${estado}`, '_blank'); //abrimos la nueva ventana (target="_blank")
    }
  </script>
  <!-- //pie-chart --><!-- index page sales reviews visitors pie chart -->
        ...
        <div class="col-md-12  widget-shadow">
          ...
          <div id="myTabContent" class="tab-content scrollbar1">
            ...
            <div role="tabpanel" class="tab-pane fade  active in" id="profile" aria-labelledby="profile-tab">
              ...
              <div class="panel panel-primary">
                <div class="panel-heading" style="background-color: #222D32 !important">
                  <h3 class="panel-title">Sudicol | Reportes Listado</h3>
                </div>
                <div class="panel-body" style="background-color: #fafafa">
           ...
           <option  selected="selected" value="Todos">Todos</option>';
                ...
                <div class="single-bottom row">
                  <div id="Listado" class="" style=""></div>
                </div>
              </div>
            </div>
