...
<head>
  ...
  <script type="text/javascript">
    var codigoc = '';
    var codigoOrdenAdd = '';
    let codOrdenCompra = '';//Esta varible solo se utiliza para cargar elementos por archivos a orden de compra
    $(document).ready(function() {
      ...
      $("#fechaCotizacion").val(f.getFullYear() + "-" + mes + "-" + dia);
    ...
    function Guardar() {
      ...
      // const ordenCompra = $("#ordenCompra").val();//por si se utiliza en un futuro
      const departamentoEntrega = $("#departamentoEntrega").val();
      const valorTotal = $("#valorTotal").val();
      // const costo = $("#costos").val();//por si se utiliza en un futuro
      // const plazoPago = $("#plazoPago").val();
      // const subCliente = $("#subCliente").val();//por si se utiliza en un futuro
      ...
      if ($("#Proyecto").val() == '') {
        swal("Atención!", "Seleccione Cliente", "warning");
        return false;
      }
      ...
      data.append('option', "guardarCotizacion");
      data.append('Formadepago', $("#Formadepago").val());
      data.append('fechaCotizacion', fechaCotizacion);
      ...
      $.ajax({
        url: 'Procesamiento/mdlCotizacion.php', //Url a donde la enviaremos
        ...
        cache: false //Para que el formulario no guarde cache    
          ...
          $('#costos, #plazoPago, #subCliente, #fechaCotizacion').attr("disabled", true);
          codigoOrdenAdd = resp;
          cargarElementosOrden();
          swal("Registro Exitoso!", "Orden " + codigoOrdenAdd + " Se ha registrado correctamente , añada productos", "success");
        $('#btng').button('reset');
    ...
    function addProducto() {
      ...
      $.ajax({
        ...
        url: "Procesamiento/mdlCotizacion.php",
        type: "POST",
        success: function(resp) {

          if (resp == "OK") {
            cargarElementosOrden();
            $("#Cantidad, #costoElemento, #valorProducto, #Elementos, #Talla").val("");
          } else {
          ...
          $.ajax({
            ...
            success: function(resp) {
              if (resp == "OK") {
                ...
                swal("Atención", "No se pudo quitar", "error");
              }
            },
    ...
    function anularCotizacion(codigobtn) {
      swal({
        title: "Atención",
        ...
        if (willDelete) {
          var parametros = {
            "option": "eliminarCotizacion",
            "codCotizacion": codigobtn
          };
          $.ajax({
            data: parametros,
            url: "Procesamiento/mdlCotizacion.php",
    ...
    function Finalizar() {
      ...
      $('#fechaRecepcion, #fechaCotizacion, #fechaRecepcion').attr("disabled", false).val(f.getFullYear() + "-" + mes + "-" + dia);
    ...
    const addProductoExcel = () =>{
      ...
      $.ajax({
        ...
        const {contadorGuardados, totalRegistros,errores} = resp;
    ...
    function imprimirCotizacion (consecutivoCotizacion){
      console.log(consecutivoCotizacion);
      url = `Reportes/rptCotizacion.php?consCotizacion=${consecutivoCotizacion}`;
          ...
          <div>
            <div class="single-bottom row">
              ...
              <div class="col-md-6 "> <br>
                <button id="btnAddProductoExcel" type="button" class="btn btn-success" onclick="addProductoExcel();" data-loading-text="<div class='loader'></div> Cargando, Espere...">Cargar Productos</button>
                <a href="Archivos/Instructivos/AddProductosOrdenCompra.xlsx" target="_blank"> <button id="btngDescargarInstructivo" type="button" class="btn btn-info" data-loading-text="<div class='loader'></div> Cargando, Espere...">Descargar Instructivo</button></a>
              </div>
            </div>
            <center>
                </br>
        ...
        <div class="col-md-12  widget-shadow">
          ...
          <div id="myTabContent" class="tab-content scrollbar1">
            ...
            <div role="tabpanel" class="tab-pane fade  active in" id="home" aria-labelledby="home-tab">
              ...
              <div class="panel panel-primary">
                <div class="panel-heading" style="background-color: #222D32 !important">
                  <h3 class="panel-title">Sudicol | Cotizaciones Formulario</h3>
                </div>
                <div class="panel-body" style="background-color: #fafafa">
                  ...
                  <div class="single-bottom row" style="">
                    ...
                    <div class="col-md-4">
                      <p>Fecha Cotizacion</p>
                      <input id="fechaCotizacion" type="date" name="fechaCotizacion" class="form-control" />
                    </div>
                    <div class="col-md-4">
                      <p><i class="fa fa-user-o"></i>Plazo de Entrega</p>
                      <input id="FechaEntrega" type="date" name="FechaEntrega" class="form-control" />
                    </div>
                    <div class="col-md-4">
                      <p><i class="fa fa-user-o"></i>Validez</p>
                    ...
                    <div class="col-md-4" hidden>
                      <p><i class="fa fa-user-o"></i>Solicitud</p>
            ...
            <div role="tabpanel" class="tab-pane fade" id="profile" aria-labelledby="profile-tab">
              ...
              <div class="panel panel-primary">
                <div class="panel-heading" style="background-color: #222D32 !important">
                  <h3 class="panel-title">Sudicol |  Cotizaciones Listado</h3>
                </div>
                <div class="panel-body" style="background-color: #fafafa">
                  <div class="single-bottom row">
            ...
            <div role="tabpanel" class="tab-pane fade" id="Masivo" aria-labelledby="Masivo-tab">
              ...
              <div class="panel panel-primary">
                <div class="panel-heading" style="background-color: #222D32 !important">
                  <h3 class="panel-title">Sudicol | Cotizaciones Masivo</h3>
                </div>
                <div class="panel-body" style="background-color: #fafafa">
                  <div class="single-bottom row">
                    <div class="col-md-4 col-md-offset-2">
                    ...
                    <div class="col-md-6 "> <br>
                      ...
                      <a href="Archivos/Instructivos/cotizacionesMasivo.xlsx" target="_blank"> <button id="btngDescargarInsctructivo2" type="button" class="btn btn-info" data-loading-text="<div class='loader'></div> Cargando, Espere...">Descargar Instructivo</button></a>
