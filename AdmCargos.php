...
function Guardar(){ 
    ...
    if($("#Nombre").val()=='') {
      swal("Atención!","Escriba Cargo","warning"); 
      return false;
    } 
    $('#btng').button('loading');
    ...
    data:{
      "Nombre":$("#Nombre").val(),
      'Ingresar':'OK'},   
     url:"Procesamiento/mdlCargos.php", 
     type:"POST",   
...
<div class="col-md-12  widget-shadow">
                    ...
                    <div role="tabpanel" class="tab-pane fade  active in" id="home" aria-labelledby="home-tab"> 
                        ...
                        <div class="panel panel-primary"> 
                            <div class="panel-heading"  style="background-color: #222D32 !important"> 
                                <h3 class="panel-title">Lumens | Cargos Formulario</h3> 
                            </div> 
                      ...
                      <div class="single-bottom row" style="">
                          ...
                          <div class="col-md-4">
                            <p><i class="fa fa-user-o"></i>Escriba Cargo</p>
                    ...
                    <div role="tabpanel" class="tab-pane fade" id="profile" aria-labelledby="profile-tab"> 
                            <p>
                                    ...
                                    <div class="panel panel-primary"> 
                                        <div class="panel-heading"  style="background-color: #222D32 !important"> 
                                            <h3 class="panel-title">Lumens |  Cargos Listado</h3> 
                                        </div> 
                                        <div class="panel-body" style="background-color: #fafafa"> 
